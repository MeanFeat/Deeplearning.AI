...
testResult testBackProp(stdNet &nn, int dataCount);
testResult testCalcCost(stdNet &nn, int dataCount);
testResult testForward(stdNet &nn, int dataCount);
testResult testForwardTrain(stdNet &nn, int dataCount);
